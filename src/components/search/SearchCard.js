...
const SearchCard = ({ item }) => {
  ...
  return (
    <div
      className="flex justify-center items-center w-[60%] xl:h-44 lg:h-44 md:h-40 h-32 rounded-lg bg-slate-200 text-black mb-4 ml-[20%] p-2 hover:cursor-pointer hover:bg-slate-300"
