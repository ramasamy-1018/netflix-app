...
const TvShowSeasonDetails = ({ tvShowId,closeOverlay }) => {
  ...
  return (
    <div className="absolute z-10 w-[70%] h-screen xl:left-80 lg:left-56 md:left-48 sm:left-44 left-28 py-6 bg-black" onClick={()=>closeOverlay()}>
      <div className="fixed overflow-scroll w-screen h-screen"> 
        <h1 className="text-xl font-extrabold mx-8 pb-2">Season1</h1>
