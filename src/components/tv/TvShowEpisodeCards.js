...
const TvShowEpisodeCards = ({episode,setShowOverlay}) => {
  ...
  return (
    <div className='flex w-[65%] mx-10 my-5 px-4 py-4 h-auto justify-center items-center rounded-lg bg-slate-200 text-black'>
      ...
      <div className='p-2 w-[70%]'>
        ...
        <p className='text-md font-light hidden md:block sm:block'>{overview.split(".")[0]}.{overview.split(".")[1]}.{overview.split(".")[2]}.</p>
      </div>
