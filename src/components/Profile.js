...
const Profile = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-black text-white">
      <h1 className="text-3xl font-semibold text-white">Who is Watching</h1>
      <div className="mt-10 pl-14 flex justify-center items-center text-lg font-bold hover:cursor-pointer" >
        <div className="pr-12 hover:scale-110" onClick={()=>navigate("/movie")}>
